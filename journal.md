...
| ----- | ---- | --- | ------ | --- | ---------------- | --- | ------ |
| P1:pretrain | yes | `pt_wo_ct.out` | ??5 folds, 15 epochs | `job.124724.out` | running | `job.123687.out` | running:3day limit |
| P1:train | yes, hit timelimit | `job.122954.out` | 7 files, 5 folds, 15 epochs | `job.124717.out` | - | - | - |
| P2:.. | not started | - | - | - | - | - | - |
