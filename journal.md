...
| Chest | DONE | `job.124916.out` | DONE w/ correct image/batch size | `job.125142.out` | rerunning | `job.127793.out` |
| Knee | DONE | `job.124944.out` | DONE w/ correct image/batch size | `job.125145.out` | rerunning | `job.127791.out` |
